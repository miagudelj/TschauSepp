 ...
 *
 */
public class AnleitungView extends JFrame {
	...
	private void init() {
		...
		// button
		spielenButton = new JButton("Spielen");
		spielenButton.setBackground(Color.white);
		spielenButton.setFont(spielenButton.getFont().deriveFont(24.0f));
		spielenButton.setBorder(BorderFactory.createStrokeBorder(new BasicStroke(2.0f), Color.black));

		buttonPanel = new JPanel(new BorderLayout(700, 40));
		buttonPanel.add(spielenButton, BorderLayout.CENTER);
	...
	private void openNamenserfassung() {
